...
namespace CsvDatabase
{
    public class CsvDataReader : IDataReader, IDisposable
    {
        ...
        //private string _sEquals2_Filter = null;
        ...
        /// <summary>
        /// Creates an instance of CSV DataReader.
        /// </summary>
        ...
        public CsvDataReader(string CSV_File, string CSV_Filter = "", char CSV_Delimiter = '|', bool bFirstRowHeader = true, int CSV_TimeOut = 5)
        {
        ...
        public bool Read()
        {
            ...
            { //Filter Data We have a Filter
                if (_bEquals_Operator == false && _bIN_Operator == false && _bLike_Operator == false && _bPipeLike_Operator == false && _bNotEquals_Operator == false) //New
                {
                    ...
                    string sHeader = _CSV_Filter.Substring(0, _CSV_Filter.IndexOf(" ")).Trim();                 
